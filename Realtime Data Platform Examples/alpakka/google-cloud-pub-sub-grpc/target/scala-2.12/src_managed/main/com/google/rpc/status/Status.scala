...
final case class Status(
    ...
    details: _root_.scala.collection.Seq[com.google.protobuf.any.Any] = _root_.scala.collection.Seq.empty
    ) extends scalapb.GeneratedMessage with scalapb.Message[Status] with scalapb.lenses.Updatable[Status] {
    @transient
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.google.rpc.status.Status = {
      var __code = this.code
      var __message = this.message
      val __details = (_root_.scala.collection.immutable.Vector.newBuilder[com.google.protobuf.any.Any] ++= this.details)
      var _done__ = false
      while (!_done__) {
        ...
        _tag__ match {
          ...
          case 26 =>
            __details += _root_.scalapb.LiteParser.readMessage(_input__, com.google.protobuf.any.Any.defaultInstance)
    ...
    def clearDetails = copy(details = _root_.scala.collection.Seq.empty)
    def addDetails(__vs: com.google.protobuf.any.Any*): Status = addAllDetails(__vs)
    def addAllDetails(__vs: TraversableOnce[com.google.protobuf.any.Any]): Status = copy(details = details ++ __vs)
    def withDetails(__v: _root_.scala.collection.Seq[com.google.protobuf.any.Any]): Status = copy(details = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 3 => _root_.scalapb.descriptors.PRepeated(details.map(_.toPMessage)(_root_.scala.collection.breakOut))
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion = com.google.rpc.status.Status
}
...
object Status extends scalapb.GeneratedMessageCompanion[com.google.rpc.status.Status] {
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): com.google.rpc.status.Status = {
    _root_.scala.Predef.require(__fieldsMap.keys.forall(_.getContainingType() == javaDescriptor), "FieldDescriptor does not match message type.")
    val __fields = javaDescriptor.getFields
    com.google.rpc.status.Status(
      __fieldsMap.getOrElse(__fields.get(0), 0).asInstanceOf[_root_.scala.Int],
      __fieldsMap.getOrElse(__fields.get(1), "").asInstanceOf[_root_.scala.Predef.String],
      __fieldsMap.getOrElse(__fields.get(2), Nil).asInstanceOf[_root_.scala.collection.Seq[com.google.protobuf.any.Any]]
    )
  }
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.google.rpc.status.Status] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      com.google.rpc.status.Status(
        ...
        __fieldsMap.get(scalaDescriptor.findFieldByNumber(3).get).map(_.as[_root_.scala.collection.Seq[com.google.protobuf.any.Any]]).getOrElse(_root_.scala.collection.Seq.empty)
      )
  ...
  implicit class StatusLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.google.rpc.status.Status]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.google.rpc.status.Status](_l) {
    ...
    def details: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.collection.Seq[com.google.protobuf.any.Any]] = field(_.details)((c_, f_) => c_.copy(details = f_))
  }
  ...
  def of(
    ...
    message: _root_.scala.Predef.String,
    details: _root_.scala.collection.Seq[com.google.protobuf.any.Any]
